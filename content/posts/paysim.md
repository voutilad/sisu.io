...
_Lopez-Rojas, Elmire, and Axelsson_[^fn:1] published a solution to take
...
## About this PaySim Series {#about-this-paysim-series}
...
-   **Clients** `:PERFORM` _zero or many_ Transactions where credits or
...
-   When **Clients** perform _two or more_ Transactions, since they
...
### About Agent Types {#about-agent-types}
...
## Making PaySim Play Nice {#making-paysim-play-nice}
...
via an buffered implementation of a `java.util.ArrayDeque`[^fn:4]. (The
...
## Going beyond PaySim 2.0 {#going-beyond-paysim-2-dot-0}
...
### 1st Party Fraudsters {#1st-party-fraudsters}
...
fulfill any debts. (See the definition in [Open Risk Manual](https://www.openriskmanual.org/wiki/First%5FParty%5FFraud).) But,
...
From an Java implementation standpoint[^fn:5], it's pretty short and sweet:
...
-   Leveraging the Neo4j Java Driver[^fn:6] to load PaySim Transactions
...
[^fn:4]: <https://docs.oracle.com/javase/8/docs/api/java/util/ArrayDeque.html>
[^fn:5]: <https://github.com/voutilad/PaySim/blob/3cfb56d0d52e45157f387144e8a4d0be7bcb7850/src/main/java/org/paysim/actors/FirstPartyFraudster.java#L44>
[^fn:6]: <https://github.com/neo4j/neo4j-java-driver>
